...
def critic_loss(actor, critic, batch, gamma=0.99):
    ...
    with torch.no_grad():
        ...
        # next_q_value = rlego.n_step_bootstrapped_returns(r, torch.logical_not(d) * gamma, min_qf_next_target)
        next_q_value = rlego.discounted_returns(r, d.logical_not() * gamma, min_qf_next_target)
    qf1, qf2 = critic(s, a)
